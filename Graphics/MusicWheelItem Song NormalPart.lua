...
return Def.ActorFrame {	
	Def.Quad{
		InitCommand=function(self)
			self:zoomto(400,30):diffuse(color("0.3,0.3,0.3,0.5")):halign(0):x(-35)
		end;
	};
	Def.Quad{
		InitCommand=function(self)
			self:zoomto(400,28):diffuse(color("0.5,0.5,0.5,0.5")):halign(0):x(6)
		end;
	};
	Def.Quad{
		InitCommand=function(self)
			self:zoomto(32,28):diffuse(color("0.5,0.5,0.5,0.5")):halign(1):x(4)
		end;
	};
	Def.Quad{
		InitCommand=function(self)
			self:zoomto(5,28):diffuse(color("0.2,0.2,0.2,0.5")):halign(0):x(-35)
		end;
	...
	LoadFont("Common Normal") .. {
		InitCommand=function(self)
			self:strokecolor(color("#000000")):halign(1):uppercase(true)
		end;
	...
	LoadFont("Common Normal") .. {
		InitCommand=function(self)
			self:diffuse(color("#c3a545")):strokecolor(color("#000000")):halign(0):uppercase(true)
		end;
