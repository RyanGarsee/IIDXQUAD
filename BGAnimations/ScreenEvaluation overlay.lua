	...
	return Def.ActorFrame {	
		Def.Quad {
			InitCommand=function(self)
				self:halign(0):y(pos1):x(-(pos2+1.25)):zoomto(width+2.5,25):diffuse(color("#000000"))
			end;
		};
		Def.Quad {
			InitCommand=function(self)
				self:halign(0):y(pos1):x(-pos2):zoomto(width,22.5):diffuse(color("#4a575d"))
			end;
		};
		Def.Quad {
			InitCommand=function(self)
				self:halign(0):y(pos1):x(-pos2):zoomto(5,15):diffuse(color("0,0,0,0"))
			end;
		...
		LoadFont("Common Normal") .. {
			Text="0000";
			InitCommand=function(self)
				self:halign(1):y(pos1):x((width-pos2-10)):zoomx(1.6):diffuse(color("#05c5db")):strokecolor(color("#000000")):diffusealpha(0.5)
			end;
			OnCommand=function(self)
		...
		Def.Quad {
			InitCommand=function(self)
				self:halign(1):y(pos1):x((width-pos2)):zoomto(33,22.5):diffuse(color("#4a575d"))
			end;
			OnCommand=function(self)
		...
		LoadFont("Common Normal") .. {
			Text=text;
			InitCommand=function(self)
				self:halign(0):y(pos1):x(-(pos2-10)):zoomx(0.7):zoomy(0.6)
			end;
			OnCommand=function(self)
				if scoremode then
					self:x(-(pos2-20))
		...
		LoadFont("Common Normal") .. {
			InitCommand=function(self)
				self:halign(1):y(pos1):x((width-pos2-10)):zoomx(1.6):diffuse(color("#05c5db")):strokecolor(color("#000000"))
			end;
			OnCommand=function(self)
...
t[#t+1] = Def.ActorFrame {	
	InitCommand=function(self)
		self:x(SCREEN_CENTER_X-240):y(SCREEN_CENTER_Y-190)
	end;
	Def.Quad {
		InitCommand=function(self)
			self:y(60):x(-5):zoomto(310,207.5):diffuse(color("0,0,0,1"))
		end;
	};
	Def.Quad {
		InitCommand=function(self)
			self:y(60):x(-152.5):zoomto(2.5,195):diffuse(color("#ffd73c"))
		end;
	};
	Def.Quad {
		InitCommand=function(self)
			self:zoomto(290,80*1.85):diffuse(color("0,0.5,0,0.5")):valign(0)
		end;
	};
	Def.Quad {
		InitCommand=function(self)
			self:zoomto(290,20*1.85):diffuse(color("0.5,0,0,0.5")):valign(1)
		end;
	};	
...
t[#t+1] = Def.ActorFrame {
	InitCommand=function(self)
		self:x(SCREEN_CENTER_X-145-240):y(SCREEN_CENTER_Y+80*1.85-190)
	end;
...
t[#t+1] = Def.ActorFrame {	
	...
	LoadFont("Common Normal") .. {
		Text="DJ LEVEL";
		InitCommand=function(self)
			self:x(-132.5):y(132.5):zoomx(1.25):zoomy(0.5):halign(0)
		end;
	};
	LoadFont("Common Normal") .. {
		InitCommand=function(self)
			self:x(132.5):y(75):halign(1):diffuse(color("#a2f1f3")):strokecolor(color("#000000")):zoom(4.5):zoomx(5.5)
		end;
		OnCommand=function(self)
	...
	LoadFont("Common Normal") .. {
		...
		InitCommand=function(self)
			self:x(-140):y(155):zoomx(0.6):zoomy(0.4):halign(0)
		end;
	};
};
